...
const FALLBACK: InstructorContext = {
  teaching_points: [
    {
      title: "Governance is a decision, not a checklist",
      concept: "Organizational judgment",
      explanation:
        "The simulator returns a recommendation, but a real organization decides whether the residual risk is acceptable. Different organizations accept different levels of risk for the same system.",
      key_takeaway: "Risk is managed and accepted, never eliminated.",
    },
  ],
  discussion_questions: [
    "Would you approve this deployment as configured?",
    "Which risks are acceptable for this organization, and why?",
    "What trade-offs did the selected controls introduce?",
    "Who should own the remaining residual risk?",
  ],
};
